        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    <h1 class="fst-italic lh-1 mb-4 text-white">
                        Give a Little, Change a Life</h1>
                ...
                <div class="causes-item">
                    <div class="causes-img">
                        ...
                        <div class="causes-link pb-2 px-3">
                            <small class="text-dark"><i class="fas fa-chart-bar text-custom me-2"></i>Goal: $3600</small>
                            <small class="text-dark"><i class="fa fa-thumbs-up text-custom me-2"></i>Raised: $4000</small>
                        </div>
                        <div class="causes-dination p-2">
                            <a class="btn-hover-bg btn btn-custom text-white py-2 px-3" href="#">Donate Now</a>
                        </div>
                    </div>
                    <div class="progress">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="causes-item">
                    ...
                    <div class="causes-content p-4">
                        ...
                        <p class="mb-4">Help today because tomorrow you may be the one who needs more helping!</p><br>
                        <a class="btn-hover-bg btn btn-custom text-white py-2 px-4" href="#">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
