...
<head>
    <meta charset="utf-8">
    <title>DonorHub - Free Charity Website Template</title>
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="facts-item">
                        ...
                        <div class="facts-text">
                            <h3 class="facts-dollar" >10000</h3>
                            <p>Our Goal</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        // Hides the pre-loader after the page has loaded
